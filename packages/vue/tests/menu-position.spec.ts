...
import { BubbleMenu, ColorPicker, MediaMenu, SlashMenu, TableHandles, TableMenu } from '@labbs/beakblock-vue';
import * as core from '@labbs/beakblock-core';
import { BUBBLE_MENU_PLUGIN_KEY, MEDIA_MENU_PLUGIN_KEY, SLASH_MENU_PLUGIN_KEY, type BeakBlockEditor } from '@labbs/beakblock-core';
